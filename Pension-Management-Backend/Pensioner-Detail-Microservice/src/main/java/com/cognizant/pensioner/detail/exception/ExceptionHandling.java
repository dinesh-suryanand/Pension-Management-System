package com.cognizant.pensioner.detail.exception;
...
import com.cognizant.pensioner.detail.model.HttpResponse;
...
public class ExceptionHandling implements ErrorController {
	...
	private static final String PENSIONER_NOT_FOUND_MSG = "No pensioner found with the given Aadhaar Number";
	...
	public ResponseEntity<HttpResponse> pensionerDetailNotFoundException(PensionerDetailNotFoundException exception) {
		logger.error(exception.getMessage());
		return createHttpResponse(HttpStatus.NOT_FOUND, PENSIONER_NOT_FOUND_MSG);
	}
